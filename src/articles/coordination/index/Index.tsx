      ...
      <div className={styles.background}>
        <div>
          ...
          <p>
            ...
            vida hasta la adolescencia. Por lo tanto, podemos dividirlo en
            etapas esperables, las cuales aparecen por ser capacidades innatas
            pero también es necesario estimularlas para pulirlas o enseñar
            habilidades un poco más complejas.
          </p>
          <div>
